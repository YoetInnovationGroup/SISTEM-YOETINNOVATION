  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-[15px] font-semibold text-neutral-900 dark:text-neutral-50">Tareas de hoy</h2>
        <span className="text-xs text-neutral-400 dark:text-neutral-500 font-medium">Completadas</span>
      </div>

      <PremiumEmptyState 
        icon={CheckCircle2}
        title="Todo completado"
        subtitle="No tienes tareas urgentes pendientes para el día de hoy."
      />
    </div>
  );
};
